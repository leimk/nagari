...
class Task{
  ...
  public function setID($id){
    ...
    if(($id!==null) && (!is_numeric($id) || $id<=0 || $id>9223372036854774807 || $this->_id!== null)){
  ...
  public function setDeadline($deadline){
    if(($deadline !== null) && (date_format(date_create_from_format('d/m/Y H:i',$deadline),'m/d/Y H:i')!= $deadline)){
      throw new TaskException('Task Deadline date or time error');
    }
